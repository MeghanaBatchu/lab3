...
%
\author{{\DIFdelbegin \DIFdel{Mukesh Saini}\DIFdelend \DIFaddbegin \DIFadd{Meghana Batchu}\DIFaddend }\\
  {Dept.of Computer Science}\\
  {\DIFdelbegin \DIFdel{National University of Singapore}\DIFdelend \DIFaddbegin \DIFadd{IIT Ropar }\DIFaddend }\\
  {\DIFdelbegin \DIFdel{mksaini}\DIFdelend \DIFaddbegin \DIFadd{2016csb1034}\DIFaddend @\DIFdelbegin \DIFdel{comp}\DIFdelend \DIFaddbegin \DIFadd{iitrpr}\DIFaddend .\DIFdelbegin \DIFdel{nus}\DIFdelend \DIFaddbegin \DIFadd{ac}\DIFaddend .\DIFdelbegin \DIFdel{edu.sg}\DIFdelend \DIFaddbegin \DIFadd{in}\DIFaddend }
  \and
  {\DIFdelbegin \DIFdel{Raghudeep Gadde}\DIFdelend \DIFaddbegin \DIFadd{Mamatha}\DIFaddend }\\
{Dept.of \DIFdelbegin \DIFdel{ECE}\DIFdelend \DIFaddbegin \DIFadd{CSE}\DIFaddend }\\
  {\DIFdelbegin \DIFdel{National University of Singapore}\DIFdelend \DIFaddbegin \DIFadd{IIT Ropar}\DIFaddend }\\
  {\DIFdelbegin \DIFdel{elerdg}\DIFdelend \DIFaddbegin \DIFadd{2014csb1006}\DIFaddend @\DIFdelbegin \DIFdel{nus}\DIFdelend \DIFaddbegin \DIFadd{iitrpr}\DIFaddend .\DIFdelbegin \DIFdel{edu}\DIFdelend \DIFaddbegin \DIFadd{ac}\DIFaddend .\DIFdelbegin \DIFdel{sg}\DIFdelend \DIFaddbegin \DIFadd{in}\DIFaddend }
\and
{\DIFdelbegin \DIFdel{Shuicheng Yan}\DIFdelend \DIFaddbegin \DIFadd{Abhinav Jindal}\DIFaddend }\\
  {Dept.of \DIFdelbegin \DIFdel{ECE}\DIFdelend \DIFaddbegin \DIFadd{CSE}\DIFaddend }\\
  {\DIFdelbegin \DIFdel{National University of Singapore}\DIFdelend \DIFaddbegin \DIFadd{IIT Ropar}\DIFaddend }\\
  {\DIFdelbegin \DIFdel{eleyans}\DIFdelend \DIFaddbegin \DIFadd{2016csb1026}\DIFaddend @\DIFdelbegin \DIFdel{nus}\DIFdelend \DIFaddbegin \DIFadd{iitrpr}\DIFaddend .\DIFdelbegin \DIFdel{edu}\DIFdelend \DIFaddbegin \DIFadd{ac}\DIFaddend .\DIFdelbegin \DIFdel{sg}\DIFdelend \DIFaddbegin \DIFadd{in}\DIFaddend }
  \and
  {\DIFdelbegin \DIFdel{Wei Tsang Ooi}\DIFdelend \DIFaddbegin \DIFadd{Shailendra}\DIFaddend }\\
{Dept.of Computer Science}\\
  {\DIFdelbegin \DIFdel{National University of Singapore}\DIFdelend \DIFaddbegin \DIFadd{IIT Ropar}\DIFaddend }\\
{\DIFdelbegin \DIFdel{ooiwt}\DIFdelend \DIFaddbegin \DIFadd{2016csb1059}\DIFaddend @\DIFdelbegin \DIFdel{comp}\DIFdelend \DIFaddbegin \DIFadd{iitrpr}\DIFaddend .\DIFdelbegin \DIFdel{nus}\DIFdelend \DIFaddbegin \DIFadd{ac}\DIFaddend .\DIFdelbegin \DIFdel{edu.sg}\DIFdelend \DIFaddbegin \DIFadd{in}\DIFaddend }}
...
based diversity measurement, \DIFdelbegin \DIFdel{state-based video editing rules, and
...
MoViMash framework.}\DIFdelend \DIFaddbegin \DIFadd{this is the abstract section }\DIFaddend \\ \\
...
%start of movimash framework section
...
The aspect of diversity is included in the framework by calculating the similarity of the views of the videos selected in the recent past. Let \matcal{H} be the history of the cameras that have been selected so far. The history is stored as set of chronologically order tuples, i.e.,
...
\begin{enumerize}
    ...
    \item Store the viewing time of the previous video and the current frame of the selected video in \matcal{H}. If we choose a scheme where each camera is selected only for fixed amount of time, we may just store the current frame of the selected video.
...
\hline
\begin{tabular}[c]{@{}l@{}}Perfor-\\ mance\end{tabular} & Type                                                   & Recordings & \begin{tabular}[c]{@{}l@{}}Duration\\ (m)\end{tabular} & \begin{tabular}[c]{@{}l@{}}Frame\\ rate\end{tabular} & Resolution \\ \hline
P1                                                      & \begin{tabular}[c]{@{}l@{}}Group\\ Dance\end{tabular}  & 12         & 4'                                                     & 30                                                   & 720*480    \\ \hline
P2                                                      & \begin{tabular}[c]{@{}l@{}}Group\\ Dance\end{tabular}  & 12         & 3'50"                                                  & 30                                                   & 720*480    \\ \hline
P3                                                      & \begin{tabular}[c]{@{}l@{}}Solo\\ Singing\end{tabular} & 5          & 2'5"                                                   & 25                                                   & 640*480    \\ \hline
\end{tabular}
\end{table}
